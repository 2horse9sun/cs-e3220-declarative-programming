...
class NECE:
  ...
  def eval(self,KM,w):
### YOUR CODE HERE
    # if isinstance(self.subformula, AT):
      w_neighbors = KM.neighbors(w)
      for neighbor in w_neighbors:
        if not self.subformula.eval(KM, neighbor):
          return False
      return True
    # if isinstance(self.subformula, NECE):
    #   return NECE(self.subformula).eval(KM, w)
    # return self.subformula.eval(KM, w)
...
### YOUR CODE HERE
    # if isinstance(self.subformula, AT):
      w_neighbors = KM.neighbors(w)
      for neighbor in w_neighbors:
        if self.subformula.eval(KM, neighbor):
          return True
      return False
    # if isinstance(self.subformula, POSS):
    #   return POSS(self.subformula).eval(KM, w)
    # return self.subformula.eval(KM, w)
    # if isinstance(self.subformula, CONJ):
    #   subformulas = self.subformula.subformulas
    #   print(subformulas)
    #   print(type(subformulas[0]))
    #   print(type(subformulas[1]))
    #   return False
