...
_lr_productions = [
  ...
  ('spec -> kripkemodel formulas','spec',2,'p_spec','modalparser.py',124),
  ('formulas -> formula SEMICOLON','formulas',2,'p_formulas_1','modalparser.py',131),
  ('formulas -> formulas formula SEMICOLON','formulas',3,'p_formulas_N','modalparser.py',135),
  ('kripkemodel -> MODEL worldlist END MODEL','kripkemodel',4,'p_kripkemodel','modalparser.py',147),
  ('worldlist -> world','worldlist',1,'p_worldlist_1','modalparser.py',156),
  ('worldlist -> worldlist world','worldlist',2,'p_worldlist_N','modalparser.py',160),
  ('world -> ID LBRACE stringlist RBRACE stringlist SEMICOLON','world',6,'p_world','modalparser.py',164),
  ('stringlist -> <empty>','stringlist',0,'p_stringlist_0','modalparser.py',168),
  ('stringlist -> stringlist1','stringlist',1,'p_stringlist_N','modalparser.py',172),
  ('stringlist1 -> ID','stringlist1',1,'p_stringlist_1','modalparser.py',176),
  ('stringlist1 -> stringlist1 COMMA ID','stringlist1',3,'p_stringlist_1N','modalparser.py',180),
  ('formula -> formula AND formula','formula',3,'p_formula_binop','modalparser.py',188),
  ('formula -> formula OR formula','formula',3,'p_formula_binop','modalparser.py',189),
  ('formula -> formula IMPL formula','formula',3,'p_formula_binop','modalparser.py',190),
  ('formula -> formula EQVI formula','formula',3,'p_formula_binop','modalparser.py',191),
  ('formula -> NOT formula','formula',2,'p_formula_unop_neg','modalparser.py',200),
  ('formula -> POSS formula','formula',2,'p_formula_unop_pos','modalparser.py',206),
  ('formula -> NECE formula','formula',2,'p_formula_unop_nec','modalparser.py',212),
  ('formula -> PTRUE','formula',1,'p_formula_true','modalparser.py',218),
  ('formula -> PFALSE','formula',1,'p_formula_false','modalparser.py',222),
  ('formula -> ID','formula',1,'p_formula_atom','modalparser.py',228),
  ('formula -> LPAREN formula RPAREN','formula',3,'p_formula_parentheses','modalparser.py',234),
]
